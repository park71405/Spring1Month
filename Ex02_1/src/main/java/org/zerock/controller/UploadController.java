...
public class UploadController {
	...
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
		...
		String uploadFolder = "C:\\KOSA_P\\upload"; // 추가
	...
	public ResponseEntity<List<AttachFileDTO>> uploadAjaxPost(MultipartFile[] uploadFile) {  //수정
		...
		String uploadFolder = "C:\\KOSA_P\\upload";
	...
	public ResponseEntity<byte[]> getFile(String fileName){
		...
		File file = new File("c:\\KOSA_P\\upload\\" + fileName);
	...
	public ResponseEntity<String> deleteFile(String fileName, String type) {
	    ...
	    try {
	        //일반 파일일 경우, 파일만 삭제
	        file = new File("c:\\KOSA_P\\upload\\" + URLDecoder.decode(fileName, "UTF-8"));
	        file.delete();
